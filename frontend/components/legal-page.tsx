  ...
  ar: {
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "6. التوصيل", paragraphs: ["في مرحلة الإطلاق الحالية، يقبل Xvond Store طلبات التوصيل داخل سلطنة عُمان فقط ولا يقبل عناوين توصيل خارج السلطنة. التوصيل مجاني للمناطق العُمانية المفعّلة في المتجر. تظهر المدة التقديرية بحسب المنطقة قبل إتمام الطلب عندما تكون الخدمة متاحة، وقد تتأثر بعوامل خارجة عن السيطرة المعقولة. مسؤوليتك تزويدنا بعنوان داخل سلطنة عُمان ورقم اتصال صحيحين وتمكين التسليم."] },
  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "6. Delivery", paragraphs: ["During the current launch phase, Xvond Store accepts delivery orders within the Sultanate of Oman only and does not accept delivery addresses outside Oman. Delivery is free to Omani areas enabled in the store. The estimated delivery window is shown by area when available and may be affected by circumstances outside reasonable control. You are responsible for providing a valid Omani delivery address and reachable phone number."] },
