...
const updated = { ar: "3 سبتمبر 2026", en: "3 September 2026" };

const policies: Record<Locale, Record<LegalKind, Policy>> = {
  ar: {
    privacy: {
      title: "سياسة الخصوصية",
      intro: "توضح هذه السياسة كيف يجمع Xvond Store البيانات الشخصية ويستخدمها ويحميها عند استخدامك للموقع أو إنشاء حساب أو تنفيذ طلب.",
      sections: [
        ...
        { title: "5. نقل البيانات خارج سلطنة عُمان", paragraphs: ["إذا استلزم تشغيل الخدمة استخدام مزود تقني أو دفع أو بريد خارج سلطنة عُمان، يتم التعامل مع نقل البيانات وفق المتطلبات النظامية المطبقة واتخاذ الضمانات المناسبة لحماية البيانات."] },
        ...
        { title: "7. حقوقك", bullets: ["طلب معرفة البيانات الشخصية المتعلقة بك وفق ما يسمح به القانون.", "طلب تصحيح أو تحديث البيانات غير الدقيقة.", "طلب محو البيانات عندما تنطبق الشروط القانونية لذلك.", "سحب الموافقة عندما تكون المعالجة مبنية عليها.", "الاعتراض أو طلب تقييد بعض أوجه المعالجة متى كان ذلك متاحًا قانونًا."] },
        ...
        { title: "11. التحديثات والتواصل", paragraphs: ["قد نحدّث هذه السياسة عند تغير خدماتنا أو المتطلبات القانونية. يظهر تاريخ آخر تحديث أعلى الصفحة. للاستفسارات أو ممارسة حقوق الخصوصية، استخدم قنوات التواصل الرسمية المنشورة في Xvond Store أو بيانات التواصل الواردة في تأكيد الطلب أو الفاتورة."] }
      ]
    },
    terms: {
      title: "شروط الاستخدام",
      intro: "تحكم هذه الشروط استخدام Xvond Store وعمليات الشراء التي تتم من خلاله. باستخدام المتجر أو تقديم طلب، فإنك توافق على هذه الشروط والسياسات المرتبطة بها.",
      sections: [
        { title: "1. المتجر والجهة المشغلة", paragraphs: ["Xvond Store هو الاسم التجاري المستخدم لواجهة المتجر الإلكترونية. تكون بيانات الجهة المشغلة القانونية وبيانات الفاتورة أو السجل، عند انطباقها، هي البيانات المعتمدة في المعاملة."] },
        ...
        { title: "3. معلومات المنتجات والأسعار", paragraphs: ["نسعى لعرض أوصاف وأسعار وصور ومخزون المنتجات بدقة. قد تختلف الألوان أو المظهر قليلًا بحسب الشاشة. إذا ظهر خطأ جوهري في السعر أو الوصف قبل تنفيذ الطلب، يحق لنا تعليق الطلب والتواصل معك للتصحيح أو الإلغاء وإعادة أي مبلغ تم تحصيله بحسب الحالة."] },
        ...
        { title: "5. الدفع", paragraphs: ["تتم المدفوعات الإلكترونية من خلال مزود الدفع المتاح في المتجر. قد يخضع الدفع لشروط مزود الخدمة وإجراءات التحقق الخاصة به. لا يعتبر الطلب مدفوعًا إلا بعد تأكيد حالة الدفع من النظام المعتمد."] },
        { title: "6. التوصيل", paragraphs: ["تظهر رسوم التوصيل والمدة التقديرية بحسب المنطقة قبل إتمام الطلب عندما تكون الخدمة متاحة. المدة تقديرية وقد تتأثر بعوامل خارجة عن السيطرة المعقولة. مسؤوليتك تزويدنا بعنوان ورقم اتصال صحيحين وتمكين التسليم."] },
        ...
        { title: "9. الملكية الفكرية", paragraphs: ["العلامة التجارية Xvond Store وتصميم الموقع والنصوص والرسومات والبرمجيات والمحتوى المملوك لنا أو المرخص لنا محمية وفق القوانين المطبقة. لا يمنحك استخدام المتجر أي حق ملكية فيها."] },
    ...
    returns: {
      ...
      intro: "تهدف هذه السياسة إلى توضيح طريقة طلب الاسترجاع أو التبديل في Xvond Store، مع الحفاظ كاملًا على الحقوق التي يقررها قانون حماية المستهلك في سلطنة عُمان.",
      sections: [
        ...
        { title: "5. تكاليف الإرجاع", paragraphs: ["إذا كان سبب الإرجاع عيبًا في المنتج أو خطأ من Xvond Store، يتحمل المتجر تكاليف الإرجاع المعقولة وفق الآلية التي يحددها الدعم. أما الإرجاع الاختياري لمنتج سليم، فقد يتحمل العميل تكلفة الشحن الفعلية إذا كانت مستحقة وتم توضيحها له قبل تنفيذ الإرجاع."] },
  ...
  en: {
    privacy: {
      ...
      intro: "This policy explains how Xvond Store collects, uses, and protects personal data when you browse the store, create an account, or place an order.",
      sections: [
        ...
        { title: "5. International transfers", paragraphs: ["Where operating the service requires a technology, payment, or communication provider outside Oman, transfers are handled in accordance with applicable legal requirements and with appropriate safeguards."] },
        ...
        { title: "11. Updates and contact", paragraphs: ["We may update this policy as our services or legal requirements change. The latest update date appears above. For privacy questions or rights requests, use the official contact channels published on Xvond Store or in your order confirmation or invoice."] }
      ]
    },
    terms: {
      title: "Terms of Use",
      intro: "These terms govern access to Xvond Store and purchases made through it. By using the store or placing an order, you agree to these terms and the policies incorporated into them.",
      sections: [
        { title: "1. Store and operator", paragraphs: ["Xvond Store is the trading name used for the online storefront. The legal operator and invoice or registration details shown for the applicable transaction are the authoritative business details."] },
        ...
        { title: "3. Products and pricing", paragraphs: ["We aim to display product descriptions, prices, images, and stock accurately. Appearance may vary slightly by screen. If a material pricing or description error is identified before fulfilment, we may pause the order and contact you to correct or cancel it and refund any collected amount where applicable."] },
        ...
        { title: "5. Payment", paragraphs: ["Electronic payments are processed through the payment provider available in the store and may be subject to that provider's verification requirements. An order is not treated as paid until the store receives an authoritative payment confirmation."] },
        { title: "6. Delivery", paragraphs: ["Delivery fees and estimated delivery windows are shown by area before checkout when delivery is available. Estimates may be affected by circumstances outside reasonable control. You are responsible for providing a correct address and reachable phone number."] },
        ...
        { title: "9. Intellectual property", paragraphs: ["The Xvond Store brand, site design, text, graphics, software, and content owned by or licensed to us are protected by applicable law. Use of the store does not transfer ownership rights to you."] },
    ...
    returns: {
      ...
      intro: "This policy explains how return and exchange requests are handled by Xvond Store while preserving all mandatory consumer rights under Omani law.",
      sections: [
