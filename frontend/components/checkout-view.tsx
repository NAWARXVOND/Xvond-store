  ...
  async function submit(formData: FormData) {
    ...
    try {
      ...
      setError(paymentMethod === "tap" && pendingPayment
        ...
        : (ar ? "تعذر إكمال الطلب. تأكد أن عنوان التوصيل داخل سلطنة عُمان وفي منطقة مدعومة." : "We could not complete the order. Make sure the delivery address is in Oman and in a supported area."));
