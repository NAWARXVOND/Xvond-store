...
export function CheckoutView({ locale }: { locale: Locale }) {
  ...
  async function submit(formData: FormData) {
    ...
    try {
      ...
      clearCart();
      router.push(appendStoreContext(`/${locale}/order-confirmation?order=${encodeURIComponent(order.order_number)}`, store));
    } catch {
